...
var _cmoncur$elm_fm$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {apiKey: a, url: b, user: c, err: d, errMsg: e, lastFmData: f};
	});
var _cmoncur$elm_fm$Model$Items = F4(
	function (a, b, c, d) {
		return {artist: a, track: b, album: c, albumImg: d};
	});
...
var _cmoncur$elm_fm$Update$updateUsername = F2(
				...
				url: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'&api_key=',
							A2(_elm_lang$core$Basics_ops['++'], model.apiKey, '&format=json&limit=11'))))
			});
	});
var _cmoncur$elm_fm$Update$updateErrMsg = F2(
	function (msg, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{errMsg: msg});
	});
var _cmoncur$elm_fm$Update$updateErr = F2(
	function (errExists, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{err: errExists});
	});
var _cmoncur$elm_fm$Update$putTrackInfo = F2(
	function (list, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{lastFmData: list});
	});
var _cmoncur$elm_fm$Update$decodeTracks = A5(
	_elm_lang$core$Json_Decode$object4,
	_cmoncur$elm_fm$Model$Items,
	A2(
...
var _cmoncur$elm_fm$Update$decodeData = A2(
	...
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			['recenttracks', 'track']),
		_elm_lang$core$Json_Decode$list(_cmoncur$elm_fm$Update$decodeTracks)));
var _cmoncur$elm_fm$Update$NewUsername = function (a) {
	return {ctor: 'NewUsername', _0: a};
};
var _cmoncur$elm_fm$Update$GetUserInfo = {ctor: 'GetUserInfo'};
var _cmoncur$elm_fm$Update$GetSucceed = function (a) {
	return {ctor: 'GetSucceed', _0: a};
};
var _cmoncur$elm_fm$Update$GetFail = function (a) {
	return {ctor: 'GetFail', _0: a};
};
var _cmoncur$elm_fm$Update$getUserInfo = function (url) {
	return A3(
		_elm_lang$core$Task$perform,
		_cmoncur$elm_fm$Update$GetFail,
		_cmoncur$elm_fm$Update$GetSucceed,
		A2(
			_elm_lang$core$Task$mapError,
			_elm_lang$core$Basics$toString,
			A2(_evancz$elm_http$Http$get, _cmoncur$elm_fm$Update$decodeData, url)));
};
var _cmoncur$elm_fm$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'GetFail':
				return {
					ctor: '_Tuple2',
					_0: A2(
						_cmoncur$elm_fm$Update$updateErrMsg,
						'There was an error fetching Last.fm data. Perhaps that user doesn\'t exist?',
						A2(_cmoncur$elm_fm$Update$updateErr, true, model)),
			...
			case 'GetSucceed':
				return {
					ctor: '_Tuple2',
					_0: A2(
						_cmoncur$elm_fm$Update$putTrackInfo,
						_p0._0,
						A2(
							_cmoncur$elm_fm$Update$updateErrMsg,
							'',
							A2(_cmoncur$elm_fm$Update$updateErr, false, model))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GetUserInfo':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _cmoncur$elm_fm$Update$getUserInfo(model.url)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_cmoncur$elm_fm$Update$updateUsername, _p0._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _cmoncur$elm_fm$View$showAlbumArt = function (imgs) {
	var img = A2(
		_elm_lang$core$Array$get,
		3,
		_elm_lang$core$Array$fromList(imgs));
	var _p0 = img;
	if (_p0.ctor === 'Nothing') {
		return 'No image';
	} else {
		var _p2 = _p0._0;
		var _p1 = _elm_lang$core$String$length(_p2);
		if (_p1 === 0) {
			return 'No image';
		} else {
			return _p2;
...
var _cmoncur$elm_fm$View$showAlbum = F3(
	function (index, imgType, list) {
		var item = A2(
			_elm_lang$core$Array$get,
			index,
		...
		if (_p3.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Empty list')
					]));
		} else {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class(imgType)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_cmoncur$elm_fm$View$showAlbumArt(_p3._0.albumImg))
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]));
...
var _cmoncur$elm_fm$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				A3(_cmoncur$elm_fm$View$showAlbum, 0, 'image_header', model.lastFmData),
				A3(_cmoncur$elm_fm$View$showAlbum, 1, 'image_secondary', model.lastFmData),
				A3(_cmoncur$elm_fm$View$showAlbum, 2, 'image_tertiary', model.lastFmData),
				A3(_cmoncur$elm_fm$View$showAlbum, 3, 'image_tertiary', model.lastFmData),
				A3(_cmoncur$elm_fm$View$showAlbum, 4, 'image_tertiary', model.lastFmData),
				A3(_cmoncur$elm_fm$View$showAlbum, 5, 'image_tertiary', model.lastFmData),
				A2(
				_elm_lang$html$Html$input,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_cmoncur$elm_fm$Update$NewUsername),
						_elm_lang$html$Html_Attributes$placeholder('Last.fm username'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_cmoncur$elm_fm$Update$GetUserInfo)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _cmoncur$elm_fm$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _cmoncur$elm_fm$Main$init = function (url) {
	return {
		ctor: '_Tuple2',
		_0: {
			...
			err: false,
			errMsg: '',
			lastFmData: _elm_lang$core$Native_List.fromArray(
				[])
		},
		_1: _cmoncur$elm_fm$Update$getUserInfo(url)
	};
};
var _cmoncur$elm_fm$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _cmoncur$elm_fm$Main$init('http://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=Cmoncur&api_key=2565f3575fabaf43ac6b3261980907d5&format=json&limit=6'),
			view: _cmoncur$elm_fm$View$view,
			update: _cmoncur$elm_fm$Update$update,
			subscriptions: _cmoncur$elm_fm$Main$subscriptions
		})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _cmoncur$elm_fm$Main$main === 'undefined' ? null : _cmoncur$elm_fm$Main$main);
